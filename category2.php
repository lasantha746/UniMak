    ...
    <div class="wrapper2" id="smooth-wrapper">
        <div class="content2" id="smooth-content">
            ...
            <section class="hero-section" id="home">
                <img class="hero-image" src="./images/category2.jpg" alt="Hero Image">
            </section>
                ...
                <div class="product-grid">
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <div class="product-card" data-product="1">
                            <img class="product-image" src="./images/category/cat07.jpg" alt="card">
                    ...
                    <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <div class="product-card" data-product="2">
                            <img class="product-image" src="./images/category/cat08.jpg" alt="card">
                            <div class="product-info">
                                <h3 class="product-title">309 X 309 CAN WITH OR WITHOUT TAGGER</h3>
                                <div class="button-group">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <div class="product-card" data-product="3">
                            <img class="product-image" src="./images/category/cat09.jpg" alt="card">
                            <div class="product-info">
                                <h3 class="product-title">309 X 309 CAN WITH OR WITHOUT TAGGER</h3>
                                <div class="button-group">
                                    <button class="btn-custom btn-see-more" onclick="openModal(1)"><span>See More</span></button>
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <div class="product-card" data-product="4">
                            <img class="product-image" src="./images/category/cat10.jpg" alt="card">
                            <div class="product-info">
                                <h3 class="product-title">309 X 309 CAN WITH OR WITHOUT TAGGER</h3>
                                <div class="button-group">
                                    <button class="btn-custom btn-see-more" onclick="openModal(1)"><span>See More</span></button>
                    ...
                    <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <div class="product-card" data-product="5">
                            <img class="product-image" src="./images/category/cat11.jpg" alt="card">
                            <div class="product-info">
                                <h3 class="product-title">309 X 309 CAN WITH OR WITHOUT TAGGER</h3>
                                <div class="button-group">
                                    <button class="btn-custom btn-see-more" onclick="openModal(1)"><span>See More</span></button>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <div class="product-card" data-product="6">
                            <img class="product-image" src="./images/category/cat12.jpg" alt="card">
                            <div class="product-info">
                                <h3 class="product-title">309 X 309 CAN WITH OR WITHOUT TAGGER</h3>
                                <div class="button-group">
                                    <button class="btn-custom btn-see-more" onclick="openModal(1)"><span>See More</span></button>
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <div class="product-card" data-product="4">
                            <img class="product-image" src="./images/category/cat13.jpg" alt="card">
                            <div class="product-info">
                                <h3 class="product-title">309 X 309 CAN WITH OR WITHOUT TAGGER</h3>
                                <div class="button-group">
                                    <button class="btn-custom btn-see-more" onclick="openModal(1)"><span>See More</span></button>
