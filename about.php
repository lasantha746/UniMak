                            ...
                            <div class="section-title">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-7">
                                        <img src="./images/about01.jpg" alt="Bottle Cap" class="rotate-img3 img-fluid" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="product-grid2">
                    ...
                    <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <div class="" data-product="2">
                            ...
                            <div class="product-info">
                                <h5 class="text-center">Name Name</h5>
                                <h6 class="text-center">Abc</h6>
                            </div>
                        </div>
                    </div>
                    <div data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <div class="" data-product="3">
                            <img class="product-image rounded-circle" src="./images/profile.jpg" alt="card">
                            <div class="product-info">
                                <h5 class="text-center">Name Name</h5>
                                <h6 class="text-center">Abc</h6>
